...
yes!(record_fields_long, Rule::record, "{ a: 1, 2, b: 3, 4 }");
yes!(record_tail, Rule::record, "{ a: 1, 2, b: 3, 4, ..R }");
yes!(record_tail_wildcard, Rule::record, "{ a: 1, 2, b: 3, 4, .._ }");
yes!(record_tail_implicit_wildcard, Rule::record, "{ a: 1, 2, b: 3, 4, .. }");
yes!(record_nested, Rule::record, "{ a: 1, 2, b: 3, 4, ..{ c: 3 } }");
